...
import { TwitterIcon, DribbbleIcon, GithubIcon, LinkedInIcon, PinterestIcon, Instaicon, SunIcon, MoonIcon } from './Icons'
...
const handleClick=()=>{
    ...
    return (
        <button  href={href} className={`${className} relative group text-light dark:text-dark my2`} onClick={handleClick} >
            {title}
...
const NavBar = () => {
    ...
    return (
        <header
            className='w-full px-32 py-8 font-med flex items-center justify-between
        dark:text-light
        relative z-10 lg:px-16 md:px-26 sm:px-8
    '
        >
        ...
        <nav className=' text-2xl'>
                ...
                <CustomLink href="/articals" title="Articles" className='ml-4 ' />
            </nav>
...
className=' min-w-[70vw] flex flex-col  justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30
        ...
        <nav className=' flex items-center flex-col justify-center'>
                ...
                <CustomMobileLink href="/articals" title="Articles" className=''  toggle={handleClick}/>
            </nav>
            <nav className='flex  items-center justify-center flex-wrap-reverse mt-2'>
                <motion.a href="https://twitter.com/shit8_shit" target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                ...
                <motion.a href="https://github.com/Ganeshshit" target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
