        ...
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 ">
            <div className=" col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              <h2 className=" mb-4 text-lg font-bold uppercase text-dark/75 dark:text-light sm:mt-5 md:mt-5 xl:mt-5">
                Biography
              </h2>
              <p className=" font-medium text-2xl sm:text-sm sm:font-bold text-left">
                Hi, I am Ganesh, a web developer and UI/UX designer with a
              ...
              <p className=" font-medium text-2xl sm:text-sm sm:font-bold text-left">
                Whether I amm working on a website, mobile app, or other digital
            ...
            <div className=" col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3 sm:mt-5 md:mt-5 xl:mt-5">
              <div className=" flex flex-col items-end justify-center xl:items-center">
                ...
                <h2 className=" text-xl font-medium capitalize text-dark/75 xl:text-center md:text-lg sm:text-base xs:text-sm  dark:text-light">
                  satisfied clients
                </h2>
              </div>
              <div className=" flex flex-col items-end justify-center  xl:items-center ">
              ...
              <div className=" flex flex-col items-end justify-center  xl:items-center">
                ...
                <h2 className=" text-xl font-medium  capitalize text-dark/75 xl:text-center md:text-lg sm:text-base  xs:text-xs dark:text-light">
                  Years of experience
                </h2>
              </div>
            </div>
